...
from models.DHIT_Net import CONFIGS as CONFIGS_UM
...
def main():
    batch_size = 1
    train_dir = r'/path/to/dataset/train/'
    val_dir = r'/path/to/dataset/val/'
    weights = [1, 1] # loss weights
    save_dir = 'DHIT_Net_ncc_{}_diffusion_{}/'.format(weights[0], weights[1])
    ...
    train_set = datasets.BrainDataset(glob.glob(train_dir + '*.pkl'), transforms=train_composed)
    val_set = datasets.BrainInferDataset(glob.glob(val_dir + '*.pkl'), transforms=val_composed)
